...
function level.load( l )
   ...
   -- Inputs have four slots that are used for the randomization of paint input.
	...
	l:addItem( Input, 6, 5, PAINT_RED, PAINT_RED, PAINT_BLUE, PAINT_BLUE )
	-- This input is 25% green and 75% orange.
	l:addItem( Input, 6, 6, PAINT_GREEN, PAINT_ORANGE, PAINT_ORANGE, PAINT_ORANGE )
	...
	l:addItem( Output, 10, 6, PAINT_RED, PAINT_GREEN, PAINT_BLUE, PAINT_YELLOW )
	-- PAINT_ANY will accept any colored paint, this also works for sensors.
	l:addItem( Output, 10, 7, PAINT_ANY )
