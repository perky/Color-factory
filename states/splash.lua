...
function splash:init()
	font_secretcode = love.graphics.newFont( 'fonts/SECRCODE.TTF', 92 )
end
...
function splash:enter( previous )
	...
	Tween( 15, self.back, { r = 30, g = 30, b = 30 }, 'inCubic' )
...
function splash.tweenCompanyIn()
	Tween( 4, splash.company, { a = 255 }, 'outQuad' )
end
